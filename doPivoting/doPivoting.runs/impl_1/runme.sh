...
HD_PWD='C:/Users/Andrej/VHDL_projects/vhdp_projekat/doPivoting/doPivoting.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log divider_32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source divider_32.tcl -notrace
